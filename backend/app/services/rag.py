...
class RAGService:
    def __init__(
        ...
        self.table_aware_ingestion_enabled = table_aware_ingestion_enabled
        self.ocr_minimum_text_characters = ocr_minimum_text_characters
        self.ocr_minimum_image_coverage = ocr_minimum_image_coverage
        self.ocr_minimum_image_count = ocr_minimum_image_count
