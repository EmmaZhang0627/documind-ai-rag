...
def build_rag_service(settings: AppSettings) -> RAGService:
    ...
    return RAGService(
        ...
        table_aware_ingestion_enabled=settings.table_aware_ingestion_enabled,
        ocr_minimum_text_characters=settings.ocr_minimum_text_characters,
        ocr_minimum_image_coverage=settings.ocr_minimum_image_coverage,
        ocr_minimum_image_count=settings.ocr_minimum_image_count,
        ocr_language=settings.ocr_language,
        ocr_dpi=settings.ocr_dpi,
        tessdata_directory=settings.tessdata_directory,
